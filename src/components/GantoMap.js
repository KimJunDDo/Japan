...
import GantoCourse from './GantoCourse';
import GantoPlace from './GantoPlace';

const GantoMap = ({ route, navigation }) => {
  ...
  return (
    <SafeAreaView
        ...
        {/* 선택된 탭에 따라 컴포넌트 렌더링 */}
        {activeTab === 'place' ? <GantoPlace /> : <GantoCourse />}

    </SafeAreaView>
  )
}

export default GantoMap
